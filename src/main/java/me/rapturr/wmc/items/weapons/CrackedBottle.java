...
public class CrackedBottle extends WesternItem {


    public CrackedBottle(String itemID, String displayName, boolean isStackable, boolean isShiny, ItemRarity rarity, Material mat, String desc, ItemType type, boolean hasActiveEffect) {
    ...
    public void hitEntityAction(Player player, EntityDamageByEntityEvent event, Entity entity, ItemStack item) {
        ...
        player.spawnParticle(Particle.BLOCK_CRACK, entity.getLocation().add(0, 0.5, 0), 40, Material.GLASS.createBlockData());
    }
    @Override

...
public class Perun extends WesternItem {
    public Perun(String itemID, String displayName, boolean isStackable, boolean isShiny, ItemRarity rarity, Material mat, String desc, ItemType type, boolean hasActiveEffect) {
    ...
    public void hitEntityAction(Player player, EntityDamageByEntityEvent event, Entity entity, ItemStack item) {
        if (!cooldown.hasCooldownTimeLeft(player)) {
            if(entity instanceof LivingEntity livingEntity) {
                ...
                livingEntity.getWorld().playSound(livingEntity.getLocation(), Sound.ENTITY_LIGHTNING_BOLT_IMPACT, 2, 1);

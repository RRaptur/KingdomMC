...
public class CrimsonWand extends WesternItem {
    public CrimsonWand(String itemID, String displayName, boolean isStackable, boolean isShiny, ItemRarity rarity, Material mat, String desc, ItemType type, boolean hasActiveEffect) {

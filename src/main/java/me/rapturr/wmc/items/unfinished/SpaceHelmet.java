...
public class SpaceHelmet extends WesternItem {
    public SpaceHelmet(String itemID, String displayName, boolean isStackable, boolean isShiny, ItemRarity rarity, Material mat, String desc, ItemType type, boolean hasActiveEffect) {
    ...
    public void rightClickAirAction(Player player, ItemStack itemStack, PlayerInteractEvent event) {
        ...
        if (helm == null) {
            ...
            player.getEquipment().setHelmet(itemStack, true);

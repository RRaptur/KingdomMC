...
public class DummyEgg extends WesternItem {


    public DummyEgg(String itemID, String displayName, boolean isStackable, boolean isShiny, ItemRarity rarity, Material mat, String desc, ItemType type, boolean hasActiveEffect) {
    ...
    public void rightClickBlockAction(Player player, ItemStack itemStack, PlayerInteractEvent event, Block block) {
        WMC.westernMobs.get("DUMMY").spawnWesternMob(player.getWorld(), block.getLocation().add(0, 1, 0));
    }
